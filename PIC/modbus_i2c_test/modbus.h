...
#define MODBUS_TIMER_T2    15
 ...
 #define MODBUS_PROTOCOL MODBUS_PROTOCOL_SERIAL
  ...
  #define MODBUS_SERIAL_TX_PIN       PIN_C4   // Data transmit pin
 #endif
  ...
  #else
   #define MODBUS_SERIAL_TIMEOUT      50000     //in us
  #endif
 #endif

 #ifndef MODBUS_SERIAL_RX_BUFFER_SIZE
  #define MODBUS_SERIAL_RX_BUFFER_SIZE  256      //size of send/rcv buffer
 #endif
